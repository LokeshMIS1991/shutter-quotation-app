...
st.set_page_config(page_title="Sidharth Shutters - Advanced Quotation Builder", layout="wide", page_icon="🛡️")
...
<div class="main-header">
    <h1>🛡️ Sidharth Shutters & Automation Pvt. Ltd.</h1>
    <p>Automated Professional Quotation & Proposal Generator</p>
</div>
""", unsafe_allow_html=True)
...
# --- PDF GENERATOR (WITH CLIENT ID & ENHANCED DESIGN) ---
def generate_pdf():
    buffer = io.BytesIO()
    ...
    # Header with Client ID included
    header_data = [
...
# --- FORMATTED EXCEL GENERATOR (WITH CLIENT ID) ---
def generate_excel():
    ...
    # Client Info block including Client ID
    client_info = [
